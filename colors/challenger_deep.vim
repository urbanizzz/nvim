...
" Edited by: urbanizzz, changed 'LineNr ctermfg' and 'TabLineSel bg'
" Added pale_green
...
call s:h("StatusLine",    {"bg": s:bg_dark, "fg": s:light_gray})
...
call s:h("TabLineSel",    {"fg": s:norm, "bg": s:pale_green, "gui": "bold", "cterm": "bold"})
